...
import {getHTTPAddress} from '../utils/additionalFunctions';
...
export default function Login() {
    ...
    return (
        <div className="flex flex-col gap-2 w-fit border border-black m-auto mt-8 p-1 shadow-lg">
            ...
            />
            <div className="flex flex-col items-center gap-1 items-start mt-5">
                <div className="flex flex-row gap-2 items-center">
                    <button
                        onClick={handleLogin}
                        className="bg-neutral-200 p-1 text-lg transition-all duration-300 hover:bg-red-300"
                    >
                        Log in
                    </button>
                    <div
